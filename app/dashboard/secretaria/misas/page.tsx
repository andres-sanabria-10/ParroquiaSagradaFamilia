...
import { FileText, Church, DollarSign, ClipboardList, Calendar, Search, Edit, Plus } from "lucide-react"
      ...
      <main className="flex-1 overflow-y-auto">
        <div className="p-6">
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">Administra el calendario de celebraciones</p>
          </div>
            ...
            <CardHeader>
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <CardDescription>Gestiona las celebraciones eucarísticas</CardDescription>
                </div>
                <Button>
                ...
                <TableBody>
                  {filteredMisas.map((misa) => (
                    <TableRow key={misa.id}>
                      ...
                      <TableCell>
                        <Badge variant={misa.estado === "Confirmada" ? "default" : "destructive"}>{misa.estado}</Badge>
                      </TableCell>
                      <TableCell>
